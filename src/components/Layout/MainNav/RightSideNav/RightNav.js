...
const RightNav = () => {
  return (
    <div className="hidden lg2:block lg2:w-[18rem] xxl:w-[24rem] bg-transparent h-full fixed top-[3.5rem] right-0 overflow-y-auto scrollbar-thin scrollbar-track-neutral-300 scrollbar-corner-rounded-2xl scrollbar-w-3 scrollbar-thumb-rounded-2xl">
