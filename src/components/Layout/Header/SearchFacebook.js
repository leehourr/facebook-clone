...
const SearchFacebook = () => {
  ...
  return (
    <div className="-ml-2 flex flex-col  items-center gap-[10px] py-4 w-full bg-white dark:bg-[#242526] dark:text-white/70 rounded-lg shadow-[0px_1px_20px_5px_rgba(0,0,0,0.1)]">
